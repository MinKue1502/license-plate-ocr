...
try:
    ...
    log_error(" YOLO không được cài đặt")
...
if TESSERACT_PATH and Path(TESSERACT_PATH).exists():
    ...
    log_warning(" Tesseract không được cài đặt hoặc không tìm thấy")
    st.warning(" Tesseract không được cài đặt. Vui lòng cài đặt để sử dụng OCR Pytesseract.")
...
if uploaded_file:
    try:
        ...
        if yolo_model is None:
            ...
            for r in results:
                if len(r.boxes) == 0:
                    log_warning(" Không phát hiện biển số nào")
            ...
            if len(plates_data) > 0:
                ...
                if final_plates:
                    ...
                    st.info(" Không có biển số hợp lệ")
