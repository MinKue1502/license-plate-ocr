...
def train_model():
    ...
    try:
        ...
        if not Path(DATASET_PATH).exists():
            ...
            print("\n Vui lòng chuẩn bị dataset tại: dataset/data.yaml")
            print(" Hướng dẫn chuẩn bị dataset:")
            print("   1. Tạo thư mục: dataset/train/images, dataset/val/images")
...
names: ['plate']
        ...
        results = model.train(
            ...
            device=0 if torch.cuda.is_available() else "cpu",  # GPU device (0 = GPU đầu tiên, -1 = CPU)
            verbose=True,
            save=True,
            augment=True,
        )
